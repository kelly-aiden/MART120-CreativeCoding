...
function setup() {
  ...
  direction1 = floor(random(1,4.9));
  direction2 = floor(random(1,4.9));
}
...
//move the red triangle along a straight line in a random direction
...
//move the blue square along a straight line in a random direction
